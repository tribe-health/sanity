...
export function OmnisearchPopover(props: OmnisearchPopoverProps) {
  ...
  const openedInput = useRef<HTMLInputElement>(null)
  ...
  return (
    <DialogCard data-ui="omnisearch-dialog" border shadow={2} overflow="hidden" ref={setDialogEl}>
      <Menu>
...
function useSearchHotkeyListener(input: RefObject<HTMLInputElement>) {
